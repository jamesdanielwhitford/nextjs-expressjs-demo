...
<h1 align="center">
  How to deploy a Next.js and Express.js application
</h1>
...
This is the code to accompany the tutorial available in our deployment guide [How to deploy a Next.js and Express.js application](https://codecapsules.io/docs/deployment/how-to-deploy-next-express-application-to-production/).
